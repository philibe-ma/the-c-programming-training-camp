...
{
    my_qsort(students, len, sizeof(struct Student), cmp_id);
...
{
    my_qsort(students, len, sizeof(struct Student), cmp_age);
...
{
    my_qsort(students, len, sizeof(struct Student), cmp_math);
